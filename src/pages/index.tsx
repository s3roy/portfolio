...
export default function Home() {
  return (
    <>
      <Head>
        <title>Souvik's Portfolio</title>
        <meta name="description" content="Generated by create next app" />
      </Head>
      <TransitionEffect />
      <main className="flex items-center text-dark w-full max-h-[82vh] dark:text-light ">
        <Layout className="pt-0 md:pt-16 sm:pt-8">
          <div className="flex items-center justify-between w-full lg:flex-col">
            <div className="w-1/2 md:w-full mt-[5vh]">
              <Image
                src={profilePic}
                alt="Souvik"
                className="w-full h-[80vh] lg:hidden md:inline-block md:w-full "
                priority
        ...
        <HireMe />
        <div className="absolute right-8 bottom-8 inlie-block w-24 md:hidden">
