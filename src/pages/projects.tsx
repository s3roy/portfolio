...
const FeaturedProject = ({ type, title, summary, img, link, github }) => {
  return (
    ...
    border border-solid border-dark bg-light shadow-2xl p-12 relative dark:bg-dark dark:border-light lg:flex-col lg:p-8
    ...
    >
      ...
      <div className="w-1/2 flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6">
        ...
        >
          <h2 className="my-2 w-full text-left text-4xl font-bold dark:text-light s:text-sm">
            {title}
          </h2>
        </Link>
